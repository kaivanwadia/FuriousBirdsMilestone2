...
void MainWindow::setParametersFromUI()
{
    ...
    if(ui->frictionCheckBox->isChecked())
        params.activeForces |= SimParameters::F_FRICTION;
...
void MainWindow::setUIFromParameters(const SimParameters &params)
{
    ...
    ui->frictionCheckBox->setChecked(params.activeForces & SimParameters::F_FRICTION);
...
void MainWindow::on_frictionCheckBox_clicked()
{
    setParametersFromUI();
}

void MainWindow::on_coeffRestitutionEdit_editingFinished()
{
    setParametersFromUI();
}

void MainWindow::on_coeffFrictionEdit_editingFinished()
{
    setParametersFromUI();
}

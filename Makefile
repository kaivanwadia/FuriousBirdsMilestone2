#############################################################################
# Makefile for building: birds
# Generated by qmake (2.01a) (Qt 4.8.1) on: Wed Oct 29 12:42:35 2014
# Project:  birds.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -spec /usr/share/qt4/mkspecs/linux-g++ -o Makefile birds.pro
#############################################################################
...
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -L/usr/X11R6/lib -lGLU -L/v/filer4b/v20q001/kwadia/PhysicalSimCS395T/BirdsMilestone2/FuriousBirdsMilestone2/SOIL/lib -lSOIL -lQtOpenGL -lQtGui -lQtCore -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = main.cpp \
		...
		camera.cpp \
		rotator.cpp \
		collisions/CTCD.cpp moc_mainwindow.cpp \
		moc_glpanel.cpp \
		moc_controller.cpp
OBJECTS       = main.o \
		mainwindow.o \
...
Makefile: birds.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -spec /usr/share/qt4/mkspecs/linux-g++ -o Makefile birds.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/birds1.0.0 || $(MKDIR) .tmp/birds1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/birds1.0.0/ && $(COPY_FILE) --parents mainwindow.h glpanel.h controller.h simulation.h simparameters.h mesh.h rigidbodytemplate.h rigidbodyinstance.h vectormath.h camera.h rotator.h collisions/Distance.h collisions/CTCD.h quadprog/eiquadprog.hpp .tmp/birds1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp glpanel.cpp controller.cpp simulation.cpp simparameters.cpp mesh.cpp rigidbodytemplate.cpp rigidbodyinstance.cpp vectormath.cpp camera.cpp rotator.cpp collisions/CTCD.cpp .tmp/birds1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/birds1.0.0/ && (cd `dirname .tmp/birds1.0.0` && $(TAR) birds1.0.0.tar birds1.0.0 && $(COMPRESS) birds1.0.0.tar) && $(MOVE) `dirname .tmp/birds1.0.0`/birds1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/birds1.0.0
...
libSOIL:
	cd /v/filer4b/v20q001/kwadia/PhysicalSimCS395T/BirdsMilestone2/FuriousBirdsMilestone2/SOIL/projects/makefile/ && make
